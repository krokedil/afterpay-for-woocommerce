...
class WC_AfterPay_Pre_Check_CustomerTest extends WP_UnitTestCase {
	...
	private $order_endpoint    = 'https://sandboxapi.horizonafs.com/eCommerceServices/eCommerce/OrderManagement/v2/OrderManagementServices.svc?wsdl';
