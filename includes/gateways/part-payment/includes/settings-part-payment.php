...
/**
 * Settings for Arvato Part Payment Gateway.
 */
return array(
	'enabled' => array(
		'title'   => __( 'Enable/Disable', 'woocommerce-gateway-arvato' ),
		'type'    => 'checkbox',
		'label'   => __( 'Enable Arvato Part Payment', 'woocommerce-gateway-arvato' ),
		'default' => 'yes'
	),
	'title' => array(
		...
		'default'     => __( 'Arvato Part Payment', 'woocommerce-gateway-arvato' ),
		'desc_tip'    => true,
	),
	'description' => array(
	...
	'debug' => array(
		...
		'default'     => 'no',
		'description' => sprintf( __( 'Log Arvato Part Payment events, such as IPN requests, inside <code>%s</code>', 'woocommerce-gateway-arvato' ), wc_get_log_file_path( 'arvato-part-payment' ) )
	),
);
